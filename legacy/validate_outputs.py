#!/usr/bin/env python3
"""Task Group 8: Output validation, regression checks, and handoff readiness.
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Validate pipeline outputs, schemas, and handoff readiness (Task Group 8).",
    )
...
def main():
    args = parse_args()
    result = run_validation(args.config, args.repo_root)
